...
def train_model(experiment_name, run_name, estimator, hyperparams, X_train, y_train):
    ...
    with mlflow.start_run(
        ...
        if hasattr(estimator, "coef_"):
            ...
            plt.savefig(fig, f"artifacts/training/feature_importance/{run_name}.png")
            plt.close(fig)
        # xgboost
            ...
            plt.savefig(fig, f"artifacts/training/feature_importance/{run_name}_weight.png")
            plt.close(fig)
            ...
            plt.savefig(fig, f"artifacts/training/feature_importance/{run_name}_gain.png")
            plt.close(fig)
        # lightgbm
            ...
            plt.savefig(fig, f"artifacts/training/feature_importance/{run_name}_split.png")
            plt.close(fig)
